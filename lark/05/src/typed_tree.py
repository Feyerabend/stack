...
@dataclass(frozen=True)
class TImplDecl:
    """Checked impl block — carries type-checked method bodies for the CEK machine."""
    trait_name: str
    for_type:   str                  # concrete type being implemented, e.g. "Color"
    methods:    tuple[TFnDecl, ...]

TDecl = Union[TFnDecl, TLetDecl, TTypeDecl, TImplDecl]
