...
typedef enum {
    ...
    TM_WEAKEN,   /* weaken a g t e   context weakening (trusted)    */
...
struct Term {
    ...
    union {
        ...
        struct { Term *ty_a; Term *ctx_g; Term *ty_t; Term *body; }                  weaken;  /* TM_WEAKEN  */
 ...
 */
typedef enum { SP_APP, SP_FST, SP_SND, SP_J, SP_NATREC, SP_BOOLREC, SP_WREC, SP_ABORT, SP_UNITREC, SP_CASESPLIT, SP_TRUNCREC, SP_CIRCREC, SP_INDREC, SP_WEAKEN } SpineKind;
struct Spine {
    SpineKind kind;
    union {
        Val *val;   /* SP_APP */
        ...
        struct { Val *a_ty; Val *ctx_g; Val *ty_t; }                        weaken_s;    /* SP_WEAKEN    */
    };
    Spine *next;
};
