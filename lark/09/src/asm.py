...
from regcheck import check_tac as _certify_allocations
...
def gen(tac: TAC) -> str:
    ...
    # Certifying pass: refuse to emit code for an allocation that fails
    # its independent certificate (regcheck.py).  Raises on violation —
    # deliberately not a user diagnostic; this is a compiler bug.
    _certify_allocations(tac, allocs)
