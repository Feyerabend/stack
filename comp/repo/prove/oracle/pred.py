"""
The predicate language — QF-UFLIA (the refinement work).
...
that restriction is the whole reason the fragment is decidable, and the refinement notes's
...
what `len` *computes* is a later version (measures), and this module has no opinion about it.
"""
