...
class LarkVM:
    ...
    # -- string-decomposition prims (for self-hosting) --
    ...
    def _rt_float_to_bits(self) -> None:
        ...
        CONTRACT: this is the identity ONLY because of the f32
    ...
    def _rt_string_to_int_raw(self) -> None:
        ...
        asm._collect_tags).  CONTRACT: word0 is the ADT tag
        ...
        if n is None:
            # COVERAGE GAP: this Err string must match cek.py's
    ...
    def _rt_string_to_float_raw(self) -> None:
        ...
        flag=1 → payload = f32 bit pattern (backend float repr); flag=0 →
        ...
        the float payload is stored as its f32 bits, not a boxed double."""
