"""
Differential test for the self-hosted TAC optimizer (
opt.lark: the port of oracle/opt.py's TAC-subset passes).
...
opt.lark + tac.lark (already green) run in Lark.
...
is the strongest obligation: the port reproduces the
...
Usage:
    python3 harness/opt_difftest.py [-v]        # -v: unified diff on fail
"""
