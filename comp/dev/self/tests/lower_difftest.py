"""
Differential test for the self-hosted lowerer (SELFHOST M7, slice 2 —
lower.lark: the port of 07/src/lower.py, typed AST → TAC).
...
lower.lark + tac.lark (already green at M7.1) run in Lark.
...
Usage:
    python3 self/tests/lower_difftest.py [-v]      # -v: unified diff on failure
"""
