"""
Smoke test for the typed AST (SELFHOST M3, slice 2 — tast.lark).
...
the M3 pipeline is assembled by CONCATENATION rather than `import` (see the note
...
under one module and runs it through the CEK interpreter (07/src/cek.py).  A
...
Usage:
    python3 self/tests/tast_smoke.py            # exits 0 on success
"""
