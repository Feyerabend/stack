"""
A decision procedure for QF-UFLIA, from scratch (PROVE.md V1 step 3, §2).
...
class Theory:
    ...
    def __init__(self, sorts: Sorts) -> None:
        ...
        # refine.py can say which one happened (V2.2‴'s rule: a checker's silence is a
        # verdict, and a report must never let silence read as approval — nor as a
        # verdict the checker never actually reached).
        self.gave_up = False
        ...
        for lit in lits:
            match lit.atom:
                ...
                case Atom(term=t):
                    ...
                    # which is why V2.2 could leave the solver untouched and V2.4 cannot.
                    cc.add(t)
