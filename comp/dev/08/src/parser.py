...
class Parser:
    ...
    def _at_measure(self) -> bool:
        ...
        the oracle's lexer is frozen (PROVE.md §0.1), so a real keyword would mean
    ...
    # -- measure declaration (the 08/ fork; PROVE.md V2.1) --
    ...
    def _parse_refine_type(self) -> Type:
        """{ v : Int | v >= 0 }  — a refinement type (the 08/ fork; PROVE.md).
