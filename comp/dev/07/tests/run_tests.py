...
# The string-decomposition prims (string_index/slice, char_to_string,
# string_to_int) are wired into the CEK interpreter only for now (self-hosting
# M0). The TAC/RV32 backends gain them when the backend is self-hosted (M6/F3).
TAC_VM_SKIP: set[str] = {"24_stringprims.lark"}
...
RV32_SKIP:  set[str] = {"24_stringprims.lark"}
RV32_XFAIL: dict[str, str] = {
    "04_tailrec.lark": "32-bit Int overflow: sum_to(1M) gives 1784293664 not 500000500000",
}
