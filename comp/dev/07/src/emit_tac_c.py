"""
Lark TAC → C emitter (the M7.0 oracle).

This is the Python reference implementation of a TAC-to-C backend.  It is the
oracle against which the eventual self-hosted `self/emit_tac_c.lark` port will be
differentially checked (SELFHOST.md M7 / OPTIMIZE.md §9 "O5′").
